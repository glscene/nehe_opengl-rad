...
void Update (float milliseconds)										// Perform Motion Updates Here
{
	...
	if (done)															// If done Is True Then There Were No Unvisited Rooms
	{
		...
		SetWindowText(g_window->hWnd,"Multiple Viewports... NeHe Productions... Maze Complete!");
		Sleep(5000);
		SetWindowText(g_window->hWnd,"Multiple Viewports... NeHe Productions... Building Maze!");
		Reset();
	}
...
int WINAPI _tWinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	// Window Title
	window.init.title			= "Multiple Viewports... NeHe Productions... Building Maze!";
