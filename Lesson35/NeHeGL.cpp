...
void flipIt(void* buffer)	// Flips the red and blue bytes (256x256)
{
	...
	__asm
	{
		mov rsi, 256*256        	// Counter set to dimensions of our memory block
		mov rdi, b	        	// Points ebx to our data (b)
		label:		        	// Label used for looping
			mov al,[rdi+0]  	// Loads value at ebx into al
			mov ah,[rdi+2]  	// Loads value at ebx+2 into ah
			mov [rdi+2],al	        // Stores value in al at ebx+2
			mov [rdi+0],ah		// Stores value in ah at ebx
